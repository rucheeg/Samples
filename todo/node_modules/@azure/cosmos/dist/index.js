(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('tslib'), require('url'), require('os'), require('@azure/cosmos-sign'), require('binary-search-bounds'), require('semaphore'), require('priorityqueuejs'), require('https'), require('querystring')) :
    typeof define === 'function' && define.amd ? define(['exports', 'tslib', 'url', 'os', '@azure/cosmos-sign', 'binary-search-bounds', 'semaphore', 'priorityqueuejs', 'https', 'querystring'], factory) :
    (factory((global.Microsoft = global.Microsoft || {}, global.Microsoft.Azure = global.Microsoft.Azure || {}, global.Microsoft.Azure.Cosmos = {}),global.tslib_1,global.url,global.os,global.cosmosSign,global.bs,global.semaphore,global.PriorityQueue,global.https,global.querystring));
}(this, (function (exports,tslib_1,url,os,cosmosSign,bs,semaphore,PriorityQueue,https,querystring) { 'use strict';
    ...
    class EndpointDiscoveryRetryPolicy {
        ...
        shouldRetry(err, retryContext, locationEndpoint) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                if (isReadRequest$$1(this.request)) {
        ...
        shouldRetry(err, retryContext) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                if (this.globalEndpointManager.canUseMultipleWriteLocations(this.request)) {
                    ...
                    const endpoints = isReadRequest$$1(this.request)
     ...
     */
    function execute$$1(globalEndpointManager, body, createRequestObjectFunc, connectionPolicy, requestOptions, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            // TODO: any request
            ...
            return apply$$1(body, createRequestObjectFunc, connectionPolicy, requestOptions, endpointDiscoveryRetryPolicy, resourceThrottleRetryPolicy, sessionReadRetryPolicy, defaultRetryPolicy, globalEndpointManager, request, {});
        });
    }
    /**
     ...
     */
    function apply$$1(body, createRequestObjectFunc, connectionPolicy, requestOptions, endpointDiscoveryRetryPolicy, resourceThrottleRetryPolicy, sessionReadRetryPolicy, defaultRetryPolicy, globalEndpointManager, request, retryContext) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            // TODO: any response
            ...
            try {
                ...
                if (!results) {
                    ...
                    yield sleep$$1(retryPolicy.retryAfterInMilliseconds);
                    return apply$$1(body, createRequestObjectFunc, connectionPolicy, requestOptions, endpointDiscoveryRetryPolicy, resourceThrottleRetryPolicy, sessionReadRetryPolicy, defaultRetryPolicy, globalEndpointManager, request, retryContext);
                }
            }
        });
    }
    function modifyRequestOptions(oldRequestOptions, // TODO: any hack is bad
    newUrl) {
    ...
    /** @hidden */
    function jsonStringifyAndEscapeNonASCII$$1(arg) {
    ...
    function parseLink$$1(resourcePath) {
    ...
    function isReadRequest$$1(request) {
        return (request.operationType === Constants.OperationTypes.Read || request.operationType === Constants.OperationTypes.Query);
    }
    ...
    function getContainerLink$$1(link) {
        return link
            .split("/")
            .slice(0, 4)
            .join("/");
    }
    function trimSlashes$$1(source) {
        return source
            .replace(Constants.RegularExpressions.TrimLeftSlashes, "")
            .replace(Constants.RegularExpressions.TrimRightSlashes, "");
    }
    function getHexaDigit$$1() {
        return Math.floor(Math.random() * 16).toString(16);
    }
    function setIsUpsertHeader$$1(headers) {
    ...
    function isResourceValid$$1(resource, err) {
    ...
    /** @ignore */
    function getIdFromLink$$1(resourceLink, isNameBased = true) {
        if (isNameBased) {
            resourceLink = trimSlashes$$1(resourceLink);
            return resourceLink;
        }
        else {
            return parseLink$$1(resourceLink).objectBody.id.toLowerCase();
        }
    }
    /** @ignore */
    function getPathFromLink$$1(resourceLink, resourceType, isNameBased = true) {
        if (isNameBased) {
            resourceLink = trimSlashes$$1(resourceLink);
            if (resourceType) {
    ...
    function getResourceIdFromPath$$1(resourcePath) {
        if (!resourcePath || typeof resourcePath !== "string") {
            return null;
        }
        const trimmedPath = trimSlashFromLeftAndRight$$1(resourcePath);
    ...
    function parseConnectionPolicy$$1(policy) {
        if (!policy) {
     ...
     */
    function createDatabaseUri$$1(databaseId) {
        databaseId = trimSlashFromLeftAndRight$$1(databaseId);
        validateResourceId$$1(databaseId);
     ...
     */
    function createDocumentCollectionUri$$1(databaseId, collectionId) {
        collectionId = trimSlashFromLeftAndRight$$1(collectionId);
        validateResourceId$$1(collectionId);
        return createDatabaseUri$$1(databaseId) + "/" + Constants.Path.CollectionsPathSegment + "/" + collectionId;
    }
    /**
     ...
     */
    function createUserUri$$1(databaseId, userId) {
        userId = trimSlashFromLeftAndRight$$1(userId);
        validateResourceId$$1(userId);
        return createDatabaseUri$$1(databaseId) + "/" + Constants.Path.UsersPathSegment + "/" + userId;
    }
    /**
     * Given a database and collection id, this creates a collection link.
     * @param {string} databaseId        -The database id
     ...
     */
    function createDocumentUri$$1(databaseId, collectionId, documentId) {
        documentId = trimSlashFromLeftAndRight$$1(documentId);
        validateResourceId$$1(documentId);
        return (createDocumentCollectionUri$$1(databaseId, collectionId) + "/" + Constants.Path.DocumentsPathSegment + "/" + documentId);
    }
    /**
     ...
     */
    function createPermissionUri$$1(databaseId, userId, permissionId) {
        permissionId = trimSlashFromLeftAndRight$$1(permissionId);
        validateResourceId$$1(permissionId);
        return createUserUri$$1(databaseId, userId) + "/" + Constants.Path.PermissionsPathSegment + "/" + permissionId;
    }
    /**
     ...
     */
    function createStoredProcedureUri$$1(databaseId, collectionId, storedProcedureId) {
        storedProcedureId = trimSlashFromLeftAndRight$$1(storedProcedureId);
        validateResourceId$$1(storedProcedureId);
        return (createDocumentCollectionUri$$1(databaseId, collectionId) +
            "/" +
     ...
     */
    function createTriggerUri$$1(databaseId, collectionId, triggerId) {
        triggerId = trimSlashFromLeftAndRight$$1(triggerId);
        validateResourceId$$1(triggerId);
        return (createDocumentCollectionUri$$1(databaseId, collectionId) + "/" + Constants.Path.TriggersPathSegment + "/" + triggerId);
    }
    /**
     ...
     * Azure Cosmos DB database service
     */
    function createUserDefinedFunctionUri$$1(databaseId, collectionId, udfId) {
        udfId = trimSlashFromLeftAndRight$$1(udfId);
        validateResourceId$$1(udfId);
        return (createDocumentCollectionUri$$1(databaseId, collectionId) +
            "/" +
    ...
    /** @hidden */
    function getPlatformDefaultHeaders$$1() {
        const defaultHeaders = {};
        defaultHeaders[Constants.HttpHeaders.UserAgent] = getUserAgent$$1();
    ...
    function getUserAgent$$1() {
        ...
        const osName = getSafeUserAgentSegmentInfo$$1(os.platform());
        const osVersion = getSafeUserAgentSegmentInfo$$1(os.release());
        const nodejsVersion = getSafeUserAgentSegmentInfo$$1(process.version);
        const userAgent = `${osName}/${osVersion} Nodejs/${nodejsVersion} ${Constants.SDKName}/${Constants.SDKVersion}`;
        return userAgent;
    }
    function getSafeUserAgentSegmentInfo$$1(s) {
    ...
    function extractPartitionKey(document, partitionKeyDefinition) {
        if (partitionKeyDefinition && partitionKeyDefinition.paths && partitionKeyDefinition.paths.length > 0) {
            ...
            partitionKeyDefinition.paths.forEach((path) => {
                const pathParts = parsePath$$1(path);
                let obj = document;
    ...
    function setAuthorizationHeader(authOptions, verb, path, resourceId, resourceType, headers) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (authOptions.permissionFeed) {
                authOptions.resourceTokens = {};
                for (const permission of authOptions.permissionFeed) {
                    const id = getResourceIdFromPath$$1(permission.resource);
                    if (!id) {
            ...
            if (authOptions.masterKey || authOptions.key) {
                ...
                headers[Constants.HttpHeaders.Authorization] = encodeURIComponent(getAuthorizationTokenUsingResourceTokens(authOptions.resourceTokens, path, resourceId));
            }
            else if (authOptions.tokenProvider) {
                headers[Constants.HttpHeaders.Authorization] = encodeURIComponent(yield authOptions.tokenProvider({ verb, path, resourceId, resourceType, headers }));
            }
        });
    }
    ...
    class DocumentProducer {
        ...
        options) {
            ...
            this.fetchFunction = (options) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                const path = getPathFromLink$$1(this.collectionLink, ResourceType.item);
                const id = getIdFromLink$$1(this.collectionLink);
                return this.clientContext.queryFeed(path, ResourceType.item, id, (result) => result.Documents, // TODO: any
    ...
    /** @hidden */
    function createCompleteRoutingMap(partitionKeyRangeInfoTuppleList, collectionUniqueId) {
    ...
    class PartitionKeyRangeCache {
        ...
        onCollectionRoutingMap(collectionLink) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                const collectionId = getIdFromLink$$1(collectionLink);
        ...
        getOverlappingRanges(collectionLink, sortedRanges) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                while (true) {
                    ...
                    if (SmartRoutingMapProvider$$1._stringCompare(currentProvidedRange.max, lastKnownTargetRange.max) > 0) {
    ...
    class ParallelQueryExecutionContextBase$$1 {
        ...
        options, partitionedQueryExecutionInfo) {
            ...
            this.sortOrders = parseOrderBy(this.partitionedQueryExecutionInfo);
        ...
        _onTargetPartitionRanges() {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const parsedRanges = parseQueryRanges(this.partitionedQueryExecutionInfo);
        ...
        _createTargetPartitionQueryExecutionContext(partitionKeyTargetRange, continuationToken) {
            ...
            let rewrittenQuery = parseRewrittenQuery(this.partitionedQueryExecutionInfo);
    ...
    class Conflict {
        ...
        read(options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                const path = getPathFromLink$$1(this.url, ResourceType.conflicts);
                const id = getIdFromLink$$1(this.url);
                const response = yield this.clientContext.read(path, ResourceType.user, id, undefined, options);
        ...
        delete(options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                const path = getPathFromLink$$1(this.url);
                const id = getIdFromLink$$1(this.url);
                const response = yield this.clientContext.delete(path, ResourceType.conflicts, id, undefined, options);
                return { body: response.result, headers: response.headers, ref: this, conflict: this };
            });
        }
    }
    ...
    class Conflicts {
        ...
        query(query, options) {
            const path = getPathFromLink$$1(this.container.url, ResourceType.conflicts);
            const id = getIdFromLink$$1(this.container.url);
            return new QueryIterator(this.clientContext, query, options, innerOptions => {
                return this.clientContext.queryFeed(path, ResourceType.conflicts, id, result => result.Conflicts, query, innerOptions);
            });
        }
        /**
         * Reads all conflicts
    ...
    class Item {
         ...
         */
        get url() {
            return createDocumentUri$$1(this.container.database.id, this.container.id, this.id);
        }
        read(options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                options = options || {};
                ...
                const path = getPathFromLink$$1(this.url);
                const id = getIdFromLink$$1(this.url);
                const response = yield this.clientContext.read(path, ResourceType.item, id, undefined, options);
                return {
        ...
        replace(body, options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const err = {};
                if (!isResourceValid$$1(body, err)) {
                    throw err;
                }
                const path = getPathFromLink$$1(this.url);
                const id = getIdFromLink$$1(this.url);
                const response = yield this.clientContext.replace(body, path, ResourceType.item, id, undefined, options);
                return {
                    body: response.result,
                    headers: response.headers,
                    ref: this,
        ...
        delete(options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const path = getPathFromLink$$1(this.url);
                const id = getIdFromLink$$1(this.url);
                const response = yield this.clientContext.delete(path, ResourceType.item, id, undefined, options);
                return {
                    body: response.result,
                    headers: response.headers,
                    ref: this,
    ...
    class ChangeFeedIterator {
        ...
        getFeedResponse() {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const response = yield this.clientContext.queryFeed(this.resourceLink, ResourceType.item, this.resourceId, result => (result ? result.Documents : []), undefined, feedOptions); // TODO: some funky issues with query feed. Probably need to change it up.
                return new ChangeFeedResponse(response.result, response.result ? response.result.length : 0, response.statusCode, response.headers);
            });
        }
    }
    ...
    class Items {
        ...
        query(query, options) {
            const path = getPathFromLink$$1(this.container.url, ResourceType.item);
            const id = getIdFromLink$$1(this.container.url);
            const fetchFunction = (innerOptions) => {
                return this.clientContext.queryFeed(path, ResourceType.item, id, result => (result ? result.Documents : []), query, innerOptions);
            };
        ...
        readChangeFeed(partitionKeyOrChangeFeedOptions, changeFeedOptions) {
            ...
            const path = getPathFromLink$$1(this.container.url, ResourceType.item);
            const id = getIdFromLink$$1(this.container.url);
            return new ChangeFeedIterator(this.clientContext, id, path, partitionKey, () => tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        create(body, options = {}) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const path = getPathFromLink$$1(this.container.url, ResourceType.item);
                const id = getIdFromLink$$1(this.container.url);
                const response = yield this.clientContext.create(body, path, ResourceType.item, id, undefined, options);
        ...
        upsert(body, options = {}) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const path = getPathFromLink$$1(this.container.url, ResourceType.item);
                const id = getIdFromLink$$1(this.container.url);
                const response = (yield this.clientContext.upsert(body, path, ResourceType.item, id, undefined, options));
                const ref = new Item(this.container, response.result.id, (options && options.partitionKey), this.clientContext);
                return {
                    body: response.result,
                    headers: response.headers,
    ...
    class StoredProcedure {
         ...
         */
        get url() {
            return createStoredProcedureUri$$1(this.container.database.id, this.container.id, this.id);
        }
        /**
        ...
        read(options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                const path = getPathFromLink$$1(this.url);
                const id = getIdFromLink$$1(this.url);
                const response = yield this.clientContext.read(path, ResourceType.sproc, id, undefined, options);
        ...
        replace(body, options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const path = getPathFromLink$$1(this.url);
                const id = getIdFromLink$$1(this.url);
                const response = yield this.clientContext.replace(body, path, ResourceType.sproc, id, undefined, options);
                return { body: response.result, headers: response.headers, ref: this, storedProcedure: this, sproc: this };
            });
        }
        /**
        ...
        delete(options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                const path = getPathFromLink$$1(this.url);
                const id = getIdFromLink$$1(this.url);
                const response = yield this.clientContext.delete(path, ResourceType.sproc, id, undefined, options);
                return { body: response.result, headers: response.headers, ref: this, storedProcedure: this, sproc: this };
            });
        }
    ...
    class StoredProcedures {
        ...
        query(query, options) {
            const path = getPathFromLink$$1(this.container.url, ResourceType.sproc);
            const id = getIdFromLink$$1(this.container.url);
            return new QueryIterator(this.clientContext, query, options, innerOptions => {
                return this.clientContext.queryFeed(path, ResourceType.sproc, id, result => result.StoredProcedures, query, innerOptions);
            });
        }
        /**
        ...
        create(body, options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const path = getPathFromLink$$1(this.container.url, ResourceType.sproc);
                const id = getIdFromLink$$1(this.container.url);
                const response = yield this.clientContext.create(body, path, ResourceType.sproc, id, undefined, options);
        ...
        upsert(body, options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const path = getPathFromLink$$1(this.container.url, ResourceType.sproc);
                const id = getIdFromLink$$1(this.container.url);
                const response = yield this.clientContext.upsert(body, path, ResourceType.sproc, id, undefined, options);
                const ref = new StoredProcedure(this.container, response.result.id, this.clientContext);
                return { body: response.result, headers: response.headers, ref, storedProcedure: ref, sproc: ref };
            });
        }
    ...
    class Trigger {
         ...
         */
        get url() {
            return createTriggerUri$$1(this.container.database.id, this.container.id, this.id);
        }
        /**
        ...
        read(options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                const path = getPathFromLink$$1(this.url);
                const id = getIdFromLink$$1(this.url);
                const response = yield this.clientContext.read(path, ResourceType.trigger, id, undefined, options);
        ...
        replace(body, options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const path = getPathFromLink$$1(this.url);
                const id = getIdFromLink$$1(this.url);
                const response = yield this.clientContext.replace(body, path, ResourceType.trigger, id, undefined, options);
                return { body: response.result, headers: response.headers, ref: this, trigger: this };
            });
        }
        /**
        ...
        delete(options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                const path = getPathFromLink$$1(this.url);
                const id = getIdFromLink$$1(this.url);
                const response = yield this.clientContext.delete(path, ResourceType.trigger, id, undefined, options);
                return { body: response.result, headers: response.headers, ref: this, trigger: this };
            });
        }
    }
    ...
    class Triggers {
        ...
        query(query, options) {
            const path = getPathFromLink$$1(this.container.url, ResourceType.trigger);
            const id = getIdFromLink$$1(this.container.url);
            return new QueryIterator(this.clientContext, query, options, innerOptions => {
                return this.clientContext.queryFeed(path, ResourceType.trigger, id, result => result.Triggers, query, innerOptions);
            });
        }
        /**
         * Read all Triggers.
        ...
        create(body, options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const path = getPathFromLink$$1(this.container.url, ResourceType.trigger);
                const id = getIdFromLink$$1(this.container.url);
                const response = yield this.clientContext.create(body, path, ResourceType.trigger, id, undefined, options);
        ...
        upsert(body, options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const path = getPathFromLink$$1(this.container.url, ResourceType.trigger);
                const id = getIdFromLink$$1(this.container.url);
                const response = yield this.clientContext.upsert(body, path, ResourceType.trigger, id, undefined, options);
                const ref = new Trigger(this.container, response.result.id, this.clientContext);
                return { body: response.result, headers: response.headers, ref, trigger: ref };
            });
        }
    ...
    class UserDefinedFunction {
         ...
         */
        get url() {
            return createUserDefinedFunctionUri$$1(this.container.database.id, this.container.id, this.id);
        }
        /**
        ...
        read(options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                const path = getPathFromLink$$1(this.url);
                const id = getIdFromLink$$1(this.url);
                const response = yield this.clientContext.read(path, ResourceType.udf, id, undefined, options);
        ...
        replace(body, options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const path = getPathFromLink$$1(this.url);
                const id = getIdFromLink$$1(this.url);
                const response = yield this.clientContext.replace(body, path, ResourceType.udf, id, undefined, options);
                return { body: response.result, headers: response.headers, ref: this, userDefinedFunction: this, udf: this };
            });
        }
        /**
        ...
        delete(options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                const path = getPathFromLink$$1(this.url);
                const id = getIdFromLink$$1(this.url);
                const response = yield this.clientContext.delete(path, ResourceType.udf, id, undefined, options);
                return { body: response.result, headers: response.headers, ref: this, userDefinedFunction: this, udf: this };
            });
        }
    }
    ...
    class UserDefinedFunctions {
        ...
        query(query, options) {
            const path = getPathFromLink$$1(this.container.url, ResourceType.udf);
            const id = getIdFromLink$$1(this.container.url);
            return new QueryIterator(this.clientContext, query, options, innerOptions => {
                return this.clientContext.queryFeed(path, ResourceType.udf, id, result => result.UserDefinedFunctions, query, innerOptions);
            });
        }
        /**
        ...
        create(body, options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const path = getPathFromLink$$1(this.container.url, ResourceType.udf);
                const id = getIdFromLink$$1(this.container.url);
                const response = yield this.clientContext.create(body, path, ResourceType.udf, id, undefined, options);
        ...
        upsert(body, options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const path = getPathFromLink$$1(this.container.url, ResourceType.udf);
                const id = getIdFromLink$$1(this.container.url);
                const response = yield this.clientContext.upsert(body, path, ResourceType.udf, id, undefined, options);
                const ref = new UserDefinedFunction(this.container, response.result.id, this.clientContext);
                return { body: response.result, headers: response.headers, ref, userDefinedFunction: ref, udf: ref };
            });
        }
    ...
    class Container {
         ...
         */
        get url() {
            return createDocumentCollectionUri$$1(this.database.id, this.id);
        }
        /**
        ...
        read(options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                const path = getPathFromLink$$1(this.url);
                const id = getIdFromLink$$1(this.url);
                const response = yield this.clientContext.read(path, ResourceType.container, id, undefined, options);
        ...
        replace(body, options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const path = getPathFromLink$$1(this.url);
                const id = getIdFromLink$$1(this.url);
                const response = yield this.clientContext.replace(body, path, ResourceType.container, id, undefined, options);
                return {
                    body: response.result,
                    headers: response.headers,
                    ref: this,
        ...
        delete(options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                const path = getPathFromLink$$1(this.url);
                const id = getIdFromLink$$1(this.url);
                const response = yield this.clientContext.delete(path, ResourceType.container, id, undefined, options);
                return {
                    body: response.result,
                    headers: response.headers,
                    ref: this,
    ...
    class Containers {
        ...
        query(query, options) {
            const path = getPathFromLink$$1(this.database.url, ResourceType.container);
            const id = getIdFromLink$$1(this.database.url);
            return new QueryIterator(this.clientContext, query, options, innerOptions => {
                return this.clientContext.queryFeed(path, ResourceType.container, id, result => result.DocumentCollections, query, innerOptions);
            });
        }
        /**
         * Creates a container.
        ...
        create(body, options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const response = yield this.clientContext.create(body, path, ResourceType.container, id, initialHeaders, options);
    ...
    class Permission {
         ...
         */
        get url() {
            return createPermissionUri$$1(this.user.database.id, this.user.id, this.id);
        }
        /**
        ...
        read(options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                const path = getPathFromLink$$1(this.url);
                const id = getIdFromLink$$1(this.url);
                const response = yield this.clientContext.read(path, ResourceType.permission, id, undefined, options);
                return {
                    body: response.result,
                    headers: response.headers,
                    ref: this,
        ...
        replace(body, options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const path = getPathFromLink$$1(this.url);
                const id = getIdFromLink$$1(this.url);
                const response = yield this.clientContext.replace(body, path, ResourceType.permission, id, undefined, options);
                return {
                    body: response.result,
                    headers: response.headers,
                    ref: this,
        ...
        delete(options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                const path = getPathFromLink$$1(this.url);
                const id = getIdFromLink$$1(this.url);
                const response = yield this.clientContext.delete(path, ResourceType.permission, id, undefined, options);
                return {
                    body: response.result,
                    headers: response.headers,
                    ref: this,
    ...
    class Permissions {
        ...
        query(query, options) {
            const path = getPathFromLink$$1(this.user.url, ResourceType.permission);
            const id = getIdFromLink$$1(this.user.url);
            return new QueryIterator(this.clientContext, query, options, innerOptions => {
                return this.clientContext.queryFeed(path, ResourceType.permission, id, result => result.Permissions, query, innerOptions);
            });
        }
        /**
        ...
        create(body, options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const path = getPathFromLink$$1(this.user.url, ResourceType.permission);
                const id = getIdFromLink$$1(this.user.url);
                const response = yield this.clientContext.create(body, path, ResourceType.permission, id, undefined, options);
        ...
        upsert(body, options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const path = getPathFromLink$$1(this.user.url, ResourceType.permission);
                const id = getIdFromLink$$1(this.user.url);
                const response = yield this.clientContext.upsert(body, path, ResourceType.permission, id, undefined, options);
                const ref = new Permission(this.user, response.result.id, this.clientContext);
                return {
                    body: response.result,
                    headers: response.headers,
    ...
    class User {
         ...
         */
        get url() {
            return createUserUri$$1(this.database.id, this.id);
        }
        /**
        ...
        replace(body, options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const path = getPathFromLink$$1(this.url);
                const id = getIdFromLink$$1(this.url);
                const response = yield this.clientContext.replace(body, path, ResourceType.user, id, undefined, options);
                return { body: response.result, headers: response.headers, ref: this, user: this };
            });
        }
        /**
        ...
        delete(options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                const path = getPathFromLink$$1(this.url);
                const id = getIdFromLink$$1(this.url);
                const response = yield this.clientContext.delete(path, ResourceType.user, id, undefined, options);
                return { body: response.result, headers: response.headers, ref: this, user: this };
            });
        }
    }
    ...
    class Users {
        ...
        query(query, options) {
            const path = getPathFromLink$$1(this.database.url, ResourceType.user);
            const id = getIdFromLink$$1(this.database.url);
            return new QueryIterator(this.clientContext, query, options, innerOptions => {
        ...
        create(body, options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const path = getPathFromLink$$1(this.database.url, ResourceType.user);
                const id = getIdFromLink$$1(this.database.url);
                const response = yield this.clientContext.create(body, path, ResourceType.user, id, undefined, options);
        ...
        upsert(body, options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const path = getPathFromLink$$1(this.database.url, ResourceType.user);
                const id = getIdFromLink$$1(this.database.url);
                const response = yield this.clientContext.upsert(body, path, ResourceType.user, id, undefined, options);
                const ref = new User(this.database, response.result.id, this.clientContext);
                return { body: response.result, headers: response.headers, ref, user: ref };
            });
        }
    ...
    class Database {
         ...
         */
        get url() {
            return createDatabaseUri$$1(this.id);
        }
        /**
        ...
        read(options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                const path = getPathFromLink$$1(this.url);
                const id = getIdFromLink$$1(this.url);
                const response = yield this.clientContext.read(path, ResourceType.database, id, undefined, options);
                return {
                    body: response.result,
                    headers: response.headers,
                    ref: this,
        ...
        delete(options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                const path = getPathFromLink$$1(this.url);
                const id = getIdFromLink$$1(this.url);
                const response = yield this.clientContext.delete(path, ResourceType.database, id, undefined, options);
                return {
                    body: response.result,
                    headers: response.headers,
                    ref: this,
    ...
    class Databases {
        ...
        query(query, options) {
            const cb = innerOptions => {
                return this.clientContext.queryFeed("/dbs", ResourceType.database, "", result => result.Databases, query, innerOptions);
            };
        ...
        create(body, options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const response = yield this.clientContext.create(body, path, ResourceType.database, undefined, initialHeaders, options);
    ...
    class Offer {
        ...
        read(options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                const response = yield this.clientContext.read(this.url, ResourceType.offer, this.id, undefined, options);
        ...
        replace(body, options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const response = yield this.clientContext.replace(body, this.url, ResourceType.offer, this.id, undefined, options);
                return { body: response.result, headers: response.headers, ref: this, offer: this };
            });
        }
    }
    ...
    class Offers {
        ...
        query(query, options) {
            return new QueryIterator(this.clientContext, query, options, innerOptions => {
                return this.clientContext.queryFeed("/offers", ResourceType.offer, "", result => result.Offers, query, innerOptions);
            });
        }
        /**
         * Read all offers.
    ...
    function getHeaders(authOptions, defaultHeaders, verb, path, resourceId, resourceType, options, partitionKeyRangeId, useMultipleWriteLocations) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (opts.partitionKey !== undefined) {
                ...
                headers[Constants.HttpHeaders.PartitionKey] = jsonStringifyAndEscapeNonASCII$$1(partitionKey);
            }
            ...
            if (authOptions.masterKey ||
                ...
                yield setAuthorizationHeader(authOptions, verb, path, resourceId, resourceType, headers);
            }
            return headers;
        });
    }
        ...
        headers) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                if (buffer) {
                    ...
                    return execute$$1(globalEndpointManager, buffer, this.createRequestObjectStub, connectionPolicy, requestOptions, request);
                }
                else {
                    return execute$$1(globalEndpointManager, null, this.createRequestObjectStub, connectionPolicy, requestOptions, request);
                }
            });
        }
        /** @ignore */
    ...
    class SessionContainer {
        ...
        get(request) {
            ...
            const collectionName = getContainerLink$$1(trimSlashes$$1(request.resourceAddress));
        ...
        remove(request) {
            ...
            const resourceAddress = trimSlashes$$1(request.resourceAddress);
            const collectionName = getContainerLink$$1(resourceAddress);
            if (collectionName) {
        ...
        getContainerName(request, headers) {
            ...
            if (!ownerFullName) {
                ownerFullName = trimSlashes$$1(request.resourceAddress);
            }
            return getContainerLink$$1(ownerFullName);
        }
    }
    ...
    class ClientContext {
        constructor(cosmosClientOptions, globalEndpointManager) {
            ...
            this.globalEndpointManager = globalEndpointManager;
            this.connectionPolicy = parseConnectionPolicy$$1(cosmosClientOptions.connectionPolicy);
        ...
        read(path, type, id, initialHeaders, options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                try {
                    const requestHeaders = yield getHeaders(this.cosmosClientOptions.auth, Object.assign({}, initialHeaders, this.cosmosClientOptions.defaultHeaders, (options && options.initialHeaders)), HTTPMethod.get, path, id, type, options, undefined, this.cosmosClientOptions.connectionPolicy.UseMultipleWriteLocations);
        ...
        queryFeed(path, type, id, resultFn, // TODO: any
        query, options, partitionKeyRangeId) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                if (query === undefined) {
                    const reqHeaders = yield getHeaders(this.cosmosClientOptions.auth, initialHeaders, HTTPMethod.get, path, id, type, options, partitionKeyRangeId, this.cosmosClientOptions.connectionPolicy.UseMultipleWriteLocations);
                    ...
                    const reqHeaders = yield getHeaders(this.cosmosClientOptions.auth, initialHeaders, HTTPMethod.post, path, id, type, options, partitionKeyRangeId, this.cosmosClientOptions.connectionPolicy.UseMultipleWriteLocations);
                    this.applySessionToken(path, reqHeaders);
        ...
        queryPartitionKeyRanges(collectionLink, query, options) {
            const path = getPathFromLink$$1(collectionLink, ResourceType.pkranges);
            const id = getIdFromLink$$1(collectionLink);
            const cb = innerOptions => {
        ...
        delete(path, type, id, initialHeaders, options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                try {
                    const reqHeaders = yield getHeaders(this.cosmosClientOptions.auth, Object.assign({}, initialHeaders, this.cosmosClientOptions.defaultHeaders, (options && options.initialHeaders)), HTTPMethod.delete, path, id, type, options, undefined, this.cosmosClientOptions.connectionPolicy.UseMultipleWriteLocations);
                    const request = {
                        client: this,
                    ...
                    if (parseLink$$1(path).type !== "colls") {
        ...
        create(body, path, type, id, initialHeaders, options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                try {
                    const requestHeaders = yield getHeaders(this.cosmosClientOptions.auth, Object.assign({}, initialHeaders, this.cosmosClientOptions.defaultHeaders, (options && options.initialHeaders)), HTTPMethod.post, path, id, type, options, undefined, this.cosmosClientOptions.connectionPolicy.UseMultipleWriteLocations);
                    const request = {
                        client: this,
        ...
        replace(resource, path, type, id, initialHeaders, options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                try {
                    const reqHeaders = yield getHeaders(this.cosmosClientOptions.auth, Object.assign({}, initialHeaders, this.cosmosClientOptions.defaultHeaders, (options && options.initialHeaders)), HTTPMethod.put, path, id, type, options, undefined, this.cosmosClientOptions.connectionPolicy.UseMultipleWriteLocations);
                    const request = {
                        client: this,
        ...
        upsert(body, path, type, id, initialHeaders, options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    setIsUpsertHeader$$1(requestHeaders);
                    this.applySessionToken(path, requestHeaders);
        ...
        options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const path = getPathFromLink$$1(sprocLink);
                const id = getIdFromLink$$1(sprocLink);
                const headers = yield getHeaders(this.cosmosClientOptions.auth, initialHeaders, HTTPMethod.post, path, id, ResourceType.sproc, options, undefined, this.cosmosClientOptions.connectionPolicy.UseMultipleWriteLocations);
                const request = {
                    client: this,
        ...
        getDatabaseAccount(options = {}) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const requestHeaders = yield getHeaders(this.cosmosClientOptions.auth, this.cosmosClientOptions.defaultHeaders, HTTPMethod.get, "", "", ResourceType.none, {}, undefined, this.cosmosClientOptions.connectionPolicy.UseMultipleWriteLocations);
                const request = {
                    client: this,
                    operationType: Constants.OperationTypes.Read,
                    path: "",
        ...
        getSessionToken(collectionLink) {
            ...
            const paths = parseLink$$1(collectionLink);
            if (paths === undefined) {
                return "";
            }
        ...
        getSessionParams(resourceLink) {
            ...
            const parserOutput = parseLink$$1(resourceLink);
    ...
    class LocationCache {
        ...
        resolveServiceEndpoint(request) {
            ...
            if (request.locationRouting.ignorePreferredLocation ||
                (!isReadRequest$$1(request) && !this.canUseMultipleWriteLocations(request))) {
                ...
                const endpoints = isReadRequest$$1(request) ? this.locationInfo.readEndpoints : this.locationInfo.writeEndpoints;
            ...
            process.nextTick(() => tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    do {
                        ...
                        yield sleep$$1(this.backgroundRefreshTimeIntervalInMS);
                    } while (shouldRefresh);
                }
                catch (err) {
                    /* swallow error */
    ...
    class CosmosClient {
        constructor(options) {
            ...
            options.connectionPolicy = parseConnectionPolicy$$1(options.connectionPolicy);
            ...
            const platformDefaultHeaders = getPlatformDefaultHeaders$$1() || {};
            ...
            options.defaultHeaders[Constants.HttpHeaders.UserAgent] = getUserAgent$$1();
