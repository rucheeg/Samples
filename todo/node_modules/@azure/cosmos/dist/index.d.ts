...
declare class ChangeFeedResponse<T> {
     ...
     * Gets the status code of the response from Azure Cosmos DB
     */
    statusCode: number, headers: IHeaders);
    /**
...
declare class ClientContext {
    ...
    /** @ignore */
    read<T>(path: string, type: ResourceType, id: string, initialHeaders: IHeaders, options?: RequestOptions): Promise<Response<T & Resource>>;
    queryFeed<T>(path: string, type: ResourceType, id: string, resultFn: (result: {
        [key: string]: any;
    }) => any[], // TODO: any
    ...
    delete<T>(path: string, type: ResourceType, id: string, initialHeaders: IHeaders, options?: RequestOptions): Promise<Response<T & Resource>>;
    create<T>(body: T, path: string, type: ResourceType, id: string, initialHeaders: IHeaders, options?: RequestOptions): Promise<Response<T & Resource>>;
    create<T, U>(body: T, path: string, type: ResourceType, id: string, initialHeaders: IHeaders, options?: RequestOptions): Promise<Response<T & U & Resource>>;
    private processQueryFeedResponse;
    private applySessionToken;
    replace<T>(resource: any, path: string, type: ResourceType, id: string, initialHeaders: IHeaders, options?: RequestOptions): Promise<Response<T & Resource>>;
    upsert<T>(body: T, path: string, type: ResourceType, id: string, initialHeaders: IHeaders, options?: RequestOptions): Promise<Response<T & Resource>>;
    upsert<T, U>(body: T, path: string, type: ResourceType, id: string, initialHeaders: IHeaders, options?: RequestOptions): Promise<Response<T & U & Resource>>;
...
export declare interface ConflictResponse extends CosmosResponse<ConflictDefinition & Resource, Conflict> {
...
export declare interface ContainerResponse extends CosmosResponse<ContainerDefinition & Resource, Container> {
...
declare interface CosmosResponse<T, U> {
    body?: T;
    headers?: IHeaders;
    ref?: U;
}
...
export declare interface DatabaseResponse extends CosmosResponse<DatabaseDefinition & Resource, Database> {
 ...
 */
export declare interface FeedOptions {
...
export declare interface ItemResponse<T extends ItemDefinition> extends CosmosResponse<T & Resource, Item> {
...
export declare interface OfferResponse extends CosmosResponse<OfferDefinition & Resource, Offer> {
...
export declare interface PermissionResponse extends CosmosResponse<PermissionDefinition & PermissionBody & Resource, Permission> {
...
export declare interface StoredProcedureResponse extends CosmosResponse<StoredProcedureDefinition & Resource, StoredProcedure> {
    /**
...
export declare interface TriggerResponse extends CosmosResponse<TriggerDefinition & Resource, Trigger> {
...
export declare interface UserDefinedFunctionResponse extends CosmosResponse<UserDefinedFunctionDefinition & Resource, UserDefinedFunction> {
...
export declare interface UserResponse extends CosmosResponse<UserDefinition & Resource, User> {
...
export declare function setAuthorizationTokenHeaderUsingMasterKey(verb: HTTPMethod, resourceId: string, resourceType: ResourceType, headers: IHeaders, masterKey: string): void;
